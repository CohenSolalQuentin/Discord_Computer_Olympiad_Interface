...
if '__main__' == __name__:
    ...
    gpt_bot_starting(program_name=gpt['program_name'], program_arguments=gpt['program_arguments'], program_directory=gpt['program_directory'] if gpt['program_directory'] is not None else '')